...
<section style="background:linear-gradient(135deg, var(--bg-app) 0%, #fff 100%); padding:60px 0; border-bottom:1px solid var(--border);">
  <div class="container" style="max-width:1200px; text-align:center;">
    ...
    <h1 class="hero-title" data-aos="fade-up" data-aos-delay="100" style="font-size:36px; margin-bottom:16px;">Archive</h1>
    <p class="section-desc" data-aos="fade-up" data-aos-delay="200" style="margin:0 auto;">Browse all past issues and volumes of our journal.</p>
  </div>
</section>
        ...
        <div class="col-md-6 col-lg-4">
          <div style="border:1px solid var(--border); border-radius:var(--radius-md); padding:20px; text-align:center; transition:all 0.3s;" class="hover-shadow">
            ...
            <div style="display:flex; justify-content:center; gap:8px;">
              <a href="{{ route('public.current-issue') }}" class="btn btn-sm btn-light border">Issue 1</a>
              <a href="{{ route('public.current-issue') }}" class="btn btn-sm btn-light border">Issue 2</a>
            </div>
          </div>
        </div>
